...
const BentoService: FC = () => {
  return (
    <div className="h-screen bg-yellow-p py-20 flex flex-col gap-6">
      <div className="h-[40%] mx-4 border-2  border-black p-4  rounded-lg">
        <h1 className="text-5xl font-bold"> Your idea is possible!</h1>
        <p className="text-black mt-4 text-2xl font-light">
      ...
      <div className="h-1/4 mx-4 p-4 border-2  border-black  rounded-lg md:hover:scale-105">
      ...
      <div className="flex ">
        <div className="w-1/2 mx-4 border-2  border-black p-4  rounded-lg hover:scale-105">
